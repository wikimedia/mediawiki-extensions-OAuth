...
Falls du nur einen Verbraucher autorisiert hast, um Zugriff auf eine Wikiuntergruppe (Websiteprojekte) zu haben, gibt es für diesen Verbraucher mehrere Zugriffstokens.',
	...
	'logentry-mwoauthconsumer-propose' => '$1 plante einen OAuth-Verbraucher (Verbraucherschlüssel $4)', # Fuzzy
	'logentry-mwoauthconsumer-update' => '$1 aktualisierte einen OAuth-Verbraucher (Verbraucherschlüssel $4)', # Fuzzy
	'logentry-mwoauthconsumer-approve' => '$1 bestätigte einen OAuth-Verbraucher von $3 (Verbraucherschlüssel $4)', # Fuzzy
	'logentry-mwoauthconsumer-reject' => '$1 lehnte einen OAuth-Verbraucher von $3 ab (Verbraucherschlüssel $4)', # Fuzzy
	'logentry-mwoauthconsumer-disable' => '$1 deaktivierte einen OAuth-Verbraucher von $3 (Verbraucherschlüssel $4)',
	'logentry-mwoauthconsumer-reenable' => '$1 reaktivierte einen OAuth-Verbraucher von $3 (Verbraucherschlüssel $4)', # Fuzzy
...
Notez bien que si vous autorisez un consommateur à n’avoir accès qu’à un sous-ensemble de wikis (projets de site), alors il y aura des jetons d’accès multiples pour ce consommateur.',
	...
	'logentry-mwoauthconsumer-propose' => '$1 a proposé un consommateur OAuth (clé du consommateur $4)', # Fuzzy
	'logentry-mwoauthconsumer-update' => '$1 a mis à jour un consommateur OAuth (clé du consommateur $4)', # Fuzzy
	'logentry-mwoauthconsumer-approve' => '$1 a approuvé un consommateur OAuth proposé par $3 (clé du consommateur $4)', # Fuzzy
	'logentry-mwoauthconsumer-reject' => '$1 a rejeté un consommateur OAuth proposé par $3 (clé du consommateur $4)', # Fuzzy
	'logentry-mwoauthconsumer-disable' => '$1 a désactivé un consommateur OAuth proposé par $3 (clé du consommateur $4)',
	'logentry-mwoauthconsumer-reenable' => '$1 a réactivé un consommateur OAuth proposé par $3 (clé du consommateur $4)', # Fuzzy
...
Teña en conta que se autoriza que un consumidor só teña acceso a un subconxunto de wikis (proxectos de sitio), entón haberá múltiples pases de acceso para ese consumidor.',
	...
	'logentry-mwoauthconsumer-propose' => '$1 propoñeu un consumidor OAuth (clave de consumidor $4)', # Fuzzy
	'logentry-mwoauthconsumer-update' => '$1 actualizou un consumidor OAuth (clave de consumidor $4)', # Fuzzy
	'logentry-mwoauthconsumer-approve' => '$1 aprobou un consumidor OAuth de $3 (clave de consumidor $4)', # Fuzzy
	'logentry-mwoauthconsumer-reject' => '$1 rexeitou un consumidor OAuth de $3 (clave de consumidor $4)', # Fuzzy
	'logentry-mwoauthconsumer-disable' => '$1 desactivou un consumidor OAuth de $3 (clave de consumidor $4)',
	'logentry-mwoauthconsumer-reenable' => '$1 reactivou un consumidor OAuth de $3 (clave de consumidor $4)', # Fuzzy
...
$messages['ja'] = array(
	...
	'logentry-mwoauthconsumer-propose' => '$1 が OAuth コンシューマーを提案 (コンシューマー キー $4)', # Fuzzy
	'logentry-mwoauthconsumer-update' => '$1 が OAuth コンシューマーを更新 (コンシューマー キー $4)', # Fuzzy
	'logentry-mwoauthconsumer-approve' => '$1 が $3 による OAuth コンシューマーを承認 (コンシューマー キー $4)', # Fuzzy
	'logentry-mwoauthconsumer-reject' => '$1 が $3 による OAuth コンシューマーを却下 (コンシューマー キー $4)', # Fuzzy
	'logentry-mwoauthconsumer-disable' => '$1 が $3 による OAuth コンシューマーを無効化 (コンシューマー キー $4)',
	'logentry-mwoauthconsumer-reenable' => '$1 が $3 による OAuth コンシューマーを再有効化 (コンシューマー キー $4)', # Fuzzy
...
Имајте предвид дека ако овластите некого со пристап на само дел од викијата (проектите) наместо сите во целина, тогаш тој потрошувач ќе има повеќе пристапни жетони.',
	...
	'logentry-mwoauthconsumer-propose' => '$1 предложи потрошувач на OAuth (потрошувачки клуч $4)', # Fuzzy
	'logentry-mwoauthconsumer-update' => '$1 измени потрошувач на OAuth (потрошувачки клуч $4)', # Fuzzy
	'logentry-mwoauthconsumer-approve' => '$1 одобри потрошувач на OAuth со $3 (потрошувачки клуч $4)', # Fuzzy
	'logentry-mwoauthconsumer-reject' => '$1 одби потрошувач на OAuth со $3 (потрошувачки клуч $4)', # Fuzzy
	'logentry-mwoauthconsumer-disable' => '$1 оневозможи потрошувач на OAuth со $3 (потрошувачки клуч $4)',
	'logentry-mwoauthconsumer-reenable' => '$1 преовозможи потрошувач на OAuth со $3 (потрошувачки клуч $4)', # Fuzzy
