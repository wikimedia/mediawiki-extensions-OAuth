...
'''$2''' vajab luba põhijuurdepääsuks sinu nimel võrgukohas $4.",
	...
	'mwoauth-grant-editmyoptions' => 'Enda eelistuste muutmine',
...
برای تکمیل این فرایند، مقدار تأیید را برای برنامه فراهم کنید: '''$1'''",
	...
	'mwoauth-consumer-email-mismatched' => 'نشانی رایانامهٔ ارائه شده باید با حساب کاربریتان مطابقت داشته باشد.',
...
''لطفاً این‌ها را برای منابع آینده ضبط کنید.''",
	...
	'mwoauthmanageconsumers-success-approved' => 'درخواست تأیید شده است.',
...
<span class="plainlinks mw-mwoautherror-details"> نشانهٔ آُآت پیدا نشد، [https://www.mediawiki.org/wiki/Help:OAuth/Errors#E004 E004]</span>',
	...
	'mwoauthserver-bad-consumer' => '«$1» دیگر یک برنامه وصل تأیید شده نیست، برای کمک با نویسندهٔ برنامه [$2 تماس بگیرید].
<span class="plainlinks mw-mwoautherror-details">نرم‌افزار متصل‌شدهٔ OAuth مورد تأیید نیست، [https://www.mediawiki.org/wiki/Help:OAuth و اشتباهات #E005 E005]</span>',
...
$messages['fi'] = array(
	...
	'mwoauth-prefs-managegrantslink' => 'Hallinnoi $1 {{PLURAL:$1|liitettyä sovellusta}}',
...
היישומים המחוברים ניגשים לחשבון שלך באמצעות פרוטוקול OAuth. <span class="plainlinks">([https://www.mediawiki.org/wiki/Special:MyLanguage/Help:OAuth מידע נוסף על יישומים מחוברים])</span>',
	...
	'mwoauthmanagemygrants-useoauth-tooltip' => 'מדוע איני {{GENDER:|יכול|יכולה}} לעדכן את הזיכיון הזה? הזיכיון הזה נותן ליישומים מחוברים שלך הרשאות בסיסיות שדרושות לו כדי לתפקד כראוי. אם אינך רוצה שליישום המחובר יהיו הרשאות כאלה, כדאי לך לשלול מהיישום את הגישה.',
...
$messages['mr'] = array(
	...
	'oauthlistconsumers' => 'OAuth अनुदानांची यादी',
...
Per acabar lo processus, provesissètz aquesta valor de verificacion a l’aplicacion : ''' $1 '''",
	...
	'mwoauth-consumer-wiki-other' => 'Projècte especific',
...
$messages['pl'] = array(
	...
	'mwoauth-consumer-rsakey' => 'Klucz publiczny RSA:',
	...
	'mwoauth-grant-group-email' => 'Wyślij e‐mail',
...
Для завершения процесса, предоставьте приложению это проверочное значение: ''' $1 '''",
	...
	'mwoauth-consumer-rsakey' => 'Публичный RSA-ключ:',
	'mwoauth-consumer-reason' => 'Причина:',
	...
	'mwoauth-consumer-conflict' => 'Кто-то изменил атрибуты клиента, пока вы их смотрели. Пожалуйста, попробуйте еще раз. Возможно, стоит проверить журнал изменений.',
	'oauthconsumerregistration' => 'Регистрация клиента OAuth',
	'mwoauthconsumerregistration-notloggedin' => 'Вы должны войти в систему для доступа к этой странице.',
	'mwoauthconsumerregistration-navigation' => 'Навигацияː',
	'mwoauthconsumerregistration-propose' => 'Предложить нового клиента',
	'mwoauthconsumerregistration-list' => 'Мой список клиентов',
...
Вам призначений маркер споживача ''\$1''' і таємний маркер '''\$2'''. \"Будь ласка, запишіть їх для використання в майбутньому.\"",
	...
	'mwoauthmanagemygrants-useoauth-tooltip' => "Чому я не можу оновити цей дозвіл? Він надає базові права під'єднаній програмі, які вимагаються для належної роботи. Якщо ви не хочете, щоб ця під'єднана програма мала ці права, ви повинні відкликати її доступ.",
...
要完成这个过程，请为该应用提供这个校验值：'''$1'''",
	...
	'mwoauth-consumer-email-unconfirmed' => '你的账户的电子邮件地址还没有确认。',
...
你可能想要检查的更改日志。',
	...
	'mwoauthconsumerregistration-propose-legend' => '新OAuth消费者应用程序',
	'mwoauthconsumerregistration-update-legend' => '更新OAuth消费者应用程序',
...
已连接的应用程序将通过 OAuth 协议访问您的账户。<span class="plainlinks">([https://www.mediawiki.org/wiki/Special:MyLanguage/Help:OAuth详细了解有关已连接的应用程序])</span>',
	...
	'logentry-mwoauthconsumer-propose' => '$1{{GENDER:$2|提议了}}一位OAuth消费者（消费者密钥$4）',
	'logentry-mwoauthconsumer-update' => '$1{{GENDER:$2|更新了}}一位OAuth消费者（消费者密钥$4）',
	'logentry-mwoauthconsumer-approve' => '$1{{GENDER:$2|批准了}}由$3做出的一位OAuth消费者（消费者密钥$4）',
	'logentry-mwoauthconsumer-reject' => '$1{{GENDER:$2|拒绝了}}由$3做出的一位OAuth消费者（消费者密钥$4）',
	'logentry-mwoauthconsumer-disable' => '$1{{GENDER:$2|禁用了}}由$3做出的一位OAuth消费者（消费者密钥$4）',
	'logentry-mwoauthconsumer-reenable' => '$1{{GENDER:$2|重新启用了}}由$3做出的一位OAuth消费者（消费者密钥$4）',
...
$5",
	'mwoauth-form-description-onewiki-nogrants' => "嗨$1，'''$2'''希望获取您在''$4''的一些简单信息。",
	...
	'mwoauth-grant-group-other' => '杂项活动',
	...
	'mwoauth-grant-editinterface' => '编辑MediaWiki名字空间和用户CSS/JavaScript',
	...
	'mwoauth-grant-highvolume' => '大容量编辑',
	'mwoauth-grant-oversight' => '隐藏用户和阻止修订',
	'mwoauth-grant-patrol' => '巡查对页面的更改',
