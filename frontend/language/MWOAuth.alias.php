...
$specialPageAliases['zh-hant'] = array(
	'OAuthConsumerRegistration' => array( 'OAuth_使用者註冊' ),
	'OAuthManageConsumers' => array( 'OAuth_使用者管理' ),
	'OAuthListConsumers' => array( 'OAuth_使用者清單' ),
	'OAuthManageMyGrants' => array( 'OAuth_使用者授權' ),
);