...
$specialPageAliases['zh-hant'] = array(
	'OAuthConsumerRegistration' => array( 'OAuth 使用者註冊' ),
	'OAuthManageConsumers' => array( 'OAuth 使用者管理' ),
	'OAuthListConsumers' => array( 'OAuth 使用者清單' ),
	'OAuthManageMyGrants' => array( 'OAuth 使用者授權' ),
);